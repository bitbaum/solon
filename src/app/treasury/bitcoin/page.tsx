        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
          ...
          <ul className="space-y-3 text-gray-700">
            <li>
              ...
              Bitcoin wallet, so its balance and history are verifiable by anyone on the
              public chain, not asserted by us.
            </li>
            <li>
              <span className="font-semibold">Recorded and linked</span> — treasury
              transactions are recorded with their txid and link straight to a public
              block explorer. If a number here can&apos;t be checked independently, it
              doesn&apos;t belong here.
            </li>
            <li>
              <span className="font-semibold">Governed spending</span> — treasury decisions
              go through the same signed-vote process as everything else: proposal, open
              session, cryptographically verified votes, recorded outcome.
            </li>
          </ul>
        </div>
