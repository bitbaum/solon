        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-8">
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm text-gray-600">
              ...
              <li><Link href="/integration" className="hover:text-navy">Integration</Link></li>
            </ul>
          </div>
          <div>
            <div className="text-sm font-semibold text-navy">Governance</div>
            <ul className="mt-3 space-y-2 text-sm text-gray-600">
              <li><Link href="/governance/voting" className="hover:text-navy">Voting</Link></li>
              <li><Link href="/governance/audit" className="hover:text-navy">Audit Trail</Link></li>
              <li><Link href="/treasury/bitcoin" className="hover:text-navy">Bitcoin Treasury</Link></li>
            </ul>
          </div>
          <div>
            <div className="text-sm font-semibold text-navy">Ecosystem</div>
            <ul className="mt-3 space-y-2 text-sm text-gray-600">
              <li><Link href="/ecosystem" className="hover:text-navy">Three Pillars</Link></li>
              {siblings.map((p) => (
                <li key={p.key}>
                  <a
                    href={p.url}
