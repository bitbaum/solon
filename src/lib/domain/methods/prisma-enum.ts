 ...
 *
 * Kept apart from the method registry so that registry stays free of Prisma:
 * the voter's browser has to compute a ballot's canonical encoding to show
 * them what they are signing, and it should not have to load a database client
 * to do it.
 */
